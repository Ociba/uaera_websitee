<head>
    <title>Uaera Uganda- {{ request()->route()->getName() }}</title>
    <meta charset="utf-8">
    ...
    <!-- Data Table Css -->
    {{-- <!-- <link rel="stylesheet" type="text/css" href="{{ asset('design/files/assets/pages/data-table/css/jquery.dataTables.min.css')}}"> --> --}}
    <link rel="stylesheet" type="text/css" href="{{ asset('design/files/bower_components/datatables.net-bs4/css/dataTables.bootstrap4.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('design/files/assets/pages/data-table/css/buttons.dataTables.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('design/files/bower_components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css')}}">
    <!-- Style.css -->
