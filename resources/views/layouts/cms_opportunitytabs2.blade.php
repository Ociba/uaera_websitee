<link href="{{asset('design/files/assets/pages/jquery.filer/css/jquery.filer.css')}}" type="text/css" rel="stylesheet" />
    <link href="{{asset('design/files/assets/pages/jquery.filer/css/themes/jquery.filer-dragdropbox-theme.css')}}" type="text/css"
        rel="stylesheet" />
<div class="row">
                ...
                <div class="row m-b-30">
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <ul class="nav nav-tabs md-tabs" style="border:none" role="tablist">
                            <li class="nav-item mr-1" style="width: 156px;">
                                <a class="nav-link active" data-toggle="tab"
                                    href="#home3" role="tab"><span style="border-radius:80%; color:black; width:100px; height:130px; font-size:medium;">1<sup>st</sup></span> | Activity</a>
                                
                            </li>
                            <li class="nav-item mr-1" style="width: 156px;">
                                <a class="nav-link" data-toggle="tab"
                                    href="#profile3" role="tab"><span style="border-radius:80%; color:black; width:100px; height:130px; font-size:medium;">2<sup>nd</sup></span> | Chatter</a>
                                
                            </li>
                            <li class="nav-item mr-1" style="width: 156px;">
                                <a class="nav-link" data-toggle="tab"
                                    href="#messages3" role="tab"><span style="border-radius:80%; color:black; width:100px; height:130px; font-size:medium;">3<sup>rd</sup></span> | Details</a>
                                
                            </li>
                            <li class="nav-item" style="width: 156px;">
                                <a class="nav-link" data-toggle="tab"
                                    href="#settings3" role="tab"><span style="border-radius:80%; color:black; width:100px; height:130px; font-size:medium;">4<sup>th</sup></span> | News</a>
                                ...
                                <div class="wrapper wrapper-640">
                                    <div class="j-tabs-container">
                                        ...
                                        <div id="tabs-section-1" class="j-tabs-section">
                                            <form action="#" method="post" class="j-forms bg-light" novalidate>
                                                <div class="content">
                                                    <div class="j-row">
                                                        <!-- end /.span6 -->
                                                        <div class="span12">
                                                            ...
                                                            <div class="unit">
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="password" class="form-control" id="inputPassword4" placeholder="Acme -1250 Widgets (Sample)">
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4">
        <div class="card">
            <div class="card-header text-center">
                <span style="font-weight: bold; color:rgb(138, 129, 129)"> 
                <span class="mytooltip tooltip-effect-5">
                <h5>Related List Quick Links  <i class="fa fa-info-circle" aria-hidden="true"></i>
                    <span class="tooltip-content clearfix">
                        <span class="tooltip-text">Also known as Euclid of
                            andria, was a Greek mathematician, often
                            referred.</span>
                    </span>
                </span>
            </h5>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <p class="ml-3 text-muted"><i class="fa fa-gg-circle pcoded-badge label label-info"></i><a href=""><span style="color:blue;">Compaign Influence (9)</span></a></p>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6">
                <p class="ml-3 text-muted"><i class="fa fa-user pcoded-badge label label-primary"></i><a href=""><span style="color:blue;">Contact Roles (3)</span></a></p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6">
                <p class="ml-3 text-muted"><i class="fa fa-pencil pcoded-badge label label-success"></i><a href=""><span style="color:blue;">Quotes (0)</span></a></p>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6">
                <p class="ml-3 text-muted"><i class="fa fa-cart-arrow-down pcoded-badge label label-danger"></i><a href=""><span style="color:blue;">Products (0)</span></a></p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6">
                <p class="ml-3 text-muted"><i class="feather icon-copy pcoded-badge label label-inverse"></i><a href=""><span style="color:blue;">Files (0)</span></a></p>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6">
                <p class="ml-3 text-muted"><i class="feather icon-file pcoded-badge label label-warning"></i><a href=""><span style="color:blue;">Notes (0)</span></a></p>
                </div>
            </div>
        </div>
        <!--Compaign Influence-->
        ...
        <div class="card-header">
            <div class="col-lg-12 col-sm-12 col-md-12">
                <p style="font-size:15px; font-weight:bold;"><i class="fa fa-bullseye pcoded-badge label label-warning"></i> Compaign Influence (3+) <span class="mr-0 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span></p>
            </div></div>
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <p class="ml-1 text-muted"><a href=""><span style="color:blue; border-bottom: 1px dotted #000;">Customer Conference-Email invite(sample)</span></a>
                    <span class="mr-3 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span>
                </p>
                    <p class="ml-1 text-muted">Customer Name : <span style="color:blue;">Jeniffer Stamos(sample)</span></p>
                    <p class="ml-1 text-muted">Influence(%)  : 0.00%</p>
                    <p class="ml-1 text-muted">Revenue Share : $0.00</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    ...
                    <p class="ml-1 text-muted">Customer Name : <span style="color:blue;">Leanne Tomlin(Sample)</span></p>
                    <p class="ml-1 text-muted">Influence(%)  : 0.00%</p>
                    <p class="ml-1 text-muted">Revenue Share : $0.00</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    ...
                    <p class="ml-1 text-muted">Customer Name : <span style="color:blue;">Howard Jones(Sample)</span></p>
                    <p class="ml-1 text-muted">Influence(%)  : 0.00%</p>
                    <p class="ml-1 text-muted">Revenue Share : $0.00</p>
                </div>
            </div>
            <div class="dropdown-divider"></div>
            <div class="text-center text-blue"><a href=""><span style="color:blue;">View all</span></a></div>
        </div>
        <!--End of Compain Influence-->
        <!--Contact Roles-->
        <div class="card">
            <div class="card-header">
            <div class="col-lg-12 col-sm-12 col-md-12">
                <p style="font-size:15px; font-weight:bold;"><i class="fa fa-user-plus pcoded-badge label label-primary"></i> Contact Roles (3) <span class="mr-0 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span></p>
            </div></div>
            <div class="row">
                ...
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <p class="ml-1 text-muted"><span style="color:blue;"><i class="fa fa-user-plus pcoded-badge label label-primary"></i></span><a href=""><span style="color:blue; border-bottom: 1px dotted #000;"> Howard Jones(sample)</span></a>
                    <span class="mr-3 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span>
                </p>
                    <p class="ml-1 text-muted">Role : <span style="font-weightbold;">Decision Maker</span></p>
                    <p class="ml-1 text-muted">Title : <span style="font-weightbold;">Buyer</span></p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <p class="ml-1 text-muted"><span style="color:blue;"><i class="fa fa-user-plus pcoded-badge label label-primary"></i></span> <a href=""><span style="color:blue; border-bottom: 1px dotted #000;"> Jeniffer Stamos(sample)</span></a>
                    <span class="mr-3 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span>
                </p>
                    <p class="ml-1 text-muted">Role : <span style="font-weightbold;">Economic Buyer</span></p>
                    <p class="ml-1 text-muted">Title : <span style="font-weightbold;">President and CEO</span></p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <p class="ml-1 text-muted"><span style="color:blue;"><i class="fa fa-user-plus pcoded-badge label label-primary"></i></span> <a href=""><span style="color:blue; border-bottom: 1px dotted #000;"> Leanne Tomlin(sample)</span></a>
                    <span class="mr-3 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span>
                </p>
                    <p class="ml-1 text-muted">Role : <span style="font-weightbold;">Business User</span></p>
                    <p class="ml-1 text-muted">Title : <span style="font-weightbold;">VP Customer Support</span></p>
                </div>
            </div>
            <div class="dropdown-divider"></div>
            <div class="text-center text-blue"><a href=""><span style="color:blue;">View all</span></a></div>
        </div>
        <!--End of Contacts Roles-->
        <div class="card pt-3">
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <p class="ml-1 text-muted"><span style="background-color:green;border-radius: 50%;padding: 0.5em 0.6em;"><i class="fa fa-user-plus"></i></span> <a href=""> Quotes (0)</a>
                    <span class="mr-3 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span>
                    </p>
                </div>
            </div>
        ...
        <div class="card pt-3">
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <p class="ml-1 text-muted"><span style="background-color:brown;border-radius: 50%;padding: 0.5em 0.6em;"><i class="fa fa-bank"></i></span> <a href=""> Products (0)</a>
                    <span class="mr-3 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span>
                    </p>
                </div>
            </div>
        ...
        <div class="card pt-3">
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <p class="ml-1 text-muted"><span style="background-color:#FF7814;border-radius: 50%;padding: 0.5em 0.7em;"><i class="fa fa-pencil-square-o"></i></span> <a href=""> Notes (0)</a>
                    <span class="pull-right mr-3 text-muted"><i class="fa fa-caret-square-o-down"></i></span>
                    </p>
                </div>
            </div>
        </div>
        <div class="card pt-3">
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <p class="ml-1 text-muted"><span style="background-color:#61403A;border-radius: 50%;padding: 0.5em 0.7em;"><i class="fa fa-file-text-o"></i></span> <a href=""> Files (0)</a>
                    <span class="mr-3 pull-right text-muted"><i class="fa fa-caret-square-o-down"></i></span>
                    </p>
                </div>
            </div>
...
<script src="{{asset('design/files/assets/pages/jquery.filer/js/jquery.filer.min.js')}}"></script>
<script src="{{asset('design/files/assets/pages/filer/custom-filer.js')}}" type="text/javascript"></script>
<script src="{{asset('design/files/assets/pages/filer/jquery.fileuploads.init.js')}}" type="text/javascript"></script>
