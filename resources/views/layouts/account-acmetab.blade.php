        ...
        <div class="row m-b-30">
            <div class="col-lg-12 col-xl-12">
                ...
                <div class="tab-content card-block">
                    <div class="tab-pane active"  style="margin-top:-50px;" id="home3"
                        role="tabpanel">
                        <div class="wrapper wrapper-640">
                            <div class="j-tabs-container">
                                ...
                                <div id="tabs-section-1" class="j-tabs-section">
                                                ...
                                                <div class="span12">
                                                    ...
                                                    <div class="unit">
                                                        <div class="form-group">
                                                            <label for="exampleFormControlInput1 mb-5">* Subject</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="exampleFormControlInput1 mb-2">Name</label>
                                                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleFormControlInput1 mb-2">Related</label>
                                                            <input type="email" class="form-control"  id="exampleFormControlInput1" placeholder="">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row card mt-4">
                                        <div class="bs-example">
                                            <div class="accordion" id="accordionExample">
                                                <div class="card">
                                                    <div class="card-header btn-sm bg-light" style="padding:3px;" id="headingOne">
                                                        <h2 class="mb-0">
                                                            <h5 class="btn font-weight-bold" data-toggle="collapse" data-target="#collapseOne"><i class="fa fa-angle-right"></i> Upcoming & Overdue</h5>									
                                                        </h2>
                                                    </div>
                                    ...
                                    <div class="row card mt-4">
                                        <div class="card-header btn-sm bg-light" style="padding:3px;">
                                            <h5><i class="fa fa-angle-down"></i> Upcoming & Overdue</h5>
                                        </div>
